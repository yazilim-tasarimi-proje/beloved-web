...
public class ProductService implements IProductService {
    ...
    private Product dtoToEntity(ProductDto dto) {
        ...
        return Product.builder()
                ...
                .stock(dto.getStock())
                .personalized(dto.getPersonalized() != null ? dto.getPersonalized() : false)
    ...
    private ProductDto entityToDto(Product product) {
        ...
        dto.setPersonalized(product.getPersonalized());
    ...
    public ProductDto updateProduct(Long id, ProductDto productDto) {
        ...
        // 🔧 UPDATE = SETTER (DOĞRU KULLANIM)
        product.setName(productDto.getName());
        product.setDescription(productDto.getDescription());
        product.setPrice(productDto.getPrice());
        product.setImageUrl(productDto.getImageUrl());
        product.setStock(productDto.getStock());
        product.setPersonalized(
                productDto.getPersonalized() != null ? productDto.getPersonalized() : false
        );
    ...
    public List<ProductDto> filterProducts(ProductFilterDto filterDto) {
        ...
        if (filterDto.getCategoryId() != null) {
            List<Long> allCategoryIds =
                    categoryService.getAllSubCategoryIds(filterDto.getCategoryId());
        ...
        if (filterDto.getPersonalized() != null) {
            spec = spec.and((root, query, cb) ->
                    cb.equal(root.get("isPersonalized"), filterDto.getPersonalized()));
        }

        if (filterDto.getProductTypes() != null &&
                !filterDto.getProductTypes().isEmpty()) {
